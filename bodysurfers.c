 ...
 * 
 * Further modifications made by Chad Messer, Sarah Haetzel, Liam Sefton, Kenny Collins:
 * This current code reflects "Custom 3", other modifications were made for experimentation
 */
...
void surfer()
{
  ...
  for(wave_count = 0; wave_count < NUM_WAVES; wave_count++)
  {
    ...
    while(my_fin_count < 2)
    {
      ...
      usleep(1); // have a refreshing beverage
